  ...
  return (
    <div className="pt-16">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <p className="text-gray-600 mb-8">Last updated: February 9, 2026</p>

        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">1. Parties</h2>
            <p className="text-gray-700 mb-4">
              This Program Agreement (&quot;Agreement&quot;) is made by and between the Client (the &quot;Principal&quot;), and Air Fresh Marketing, LLC (&quot;Agency&quot;) (each a &quot;Party&quot; and collectively the &quot;Parties&quot;), as Principal wishes to appoint the Agency as its agent to provide staffing and payroll services. The Parties therefore hereby agree as follows.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              No Refunds will be permitted. The client understands that the entirety of the fees outlined in this agreement are due before the event upon receipt. The terms of this agreement are binding and may not be canceled for any reason.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              ...
              <li><strong>Workers&apos; Compensation Insurance</strong> as required by applicable law, and Employer&apos;s Liability Insurance with a limit not less than $1,000,000 per occurrence;</li>
            </ul>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              ...
              <li><strong>Headings:</strong> The headings of sections herein are provided for reference only and are not intended to be a part of or affect the meaning of any section.</li>
              <li><strong>Signatures:</strong> This Agreement may be executed in one or more counterparts, each of which shall be deemed an original but all of which shall constitute one and the same instrument. For purposes of this Agreement, use of a facsimile, e-mail, or other electronic medium shall have the same force and effect as an original signature. Parties may also confirm this Agreement via clicked confirmation link.</li>
            </ul>
          </section>
