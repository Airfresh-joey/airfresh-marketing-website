...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${DOMAIN}/services/brand-strategy`, lastModified: today, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${DOMAIN}/services/event-production`, lastModified: today, changeFrequency: 'weekly', priority: 0.8 },
    ...
    { url: `${DOMAIN}/talent`, lastModified: today, changeFrequency: 'monthly', priority: 0.7 },
