...
export default function BookPage() {
  ...
  const openCalendly = () => {
    ...
    if (window.Calendly) {
      // @ts-ignore
      window.Calendly.initPopupWidget({ url: 'https://calendly.com/joeykercher/discovery-call' });
    }
  };
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', color: '#fff' }}>
      ...
      <div style={{ padding: '120px 24px 80px', textAlign: 'center' }}>
        <p style={{ fontSize: '12px', fontWeight: 600, letterSpacing: '3px', textTransform: 'uppercase', color: '#00b4d8', marginBottom: '16px' }}>
          Discovery Call
        </p>
        ...
        {/* Powered by AFM — right under the button */}
