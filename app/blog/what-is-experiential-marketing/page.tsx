      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section id="types" className="mb-16">
          ...
          <div className="space-y-6">
            ...
            <Card><CardContent className="p-6"><h3 className="text-xl font-bold mb-3 flex items-center gap-2"><TrendingUp className="w-5 h-5 text-cyan-600" /><Link href="/product-sampling-agency" className="text-cyan-700 hover:underline">Product Sampling</Link></h3><p className="text-gray-700">Giving consumers free samples to try your product firsthand. Strategic <Link href="/product-sampling-agency" className="text-cyan-600 hover:underline">product sampling campaigns</Link> with trained brand ambassadors can significantly impact trial rates and purchase intent.</p></CardContent></Card>
          </div>
        </section>
        ...
        <section id="planning" className="mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4"><div className="w-10 h-10 bg-cyan-600 text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">5</div><div><h4 className="font-bold text-lg mb-2">Staff with Great People</h4><p className="text-gray-700">Your <Link href="/brand-ambassador-agency" className="text-cyan-600 hover:underline">brand ambassadors</Link> ARE your brand during the activation. Partner with an <Link href="/experiential-marketing-agency" className="text-cyan-600 hover:underline">experiential marketing agency</Link> to source the right talent.</p></div></div>
