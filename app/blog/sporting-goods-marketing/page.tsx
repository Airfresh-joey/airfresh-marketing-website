...
export default function SportingGoodsMarketing() {
  return (
    <article className="pt-16 min-h-screen bg-white">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
                  ...
                  "@graph": [
                            {
                                      "@type": "Article",
                                      "headline": "Sporting Goods Retail Marketing",
                                      "description": "Dick's, REI, and specialty sports retailers need knowledgeable staff. Here's how to market in sporting goods.",
                                      ...
                                      "mainEntityOfPage": {
                                                "@type": "WebPage",
                                                "@id": "https://www.airfreshmarketing.com/blog/sporting-goods-marketing"
                                      },
                                      "inLanguage": "en-US",
                                      "keywords": "sporting goods marketing, dicks sporting goods, rei marketing, sports retail marketing, athletic retail"
                            },
                            {
                                      ...
                                      "itemListElement": [
                                                ...
                                                },
                                                {
                                                          "@type": "ListItem",
                                                          "position": 3,
                                                          "name": "Sporting Goods Retail Marketing",
                                                          "item": "https://www.airfreshmarketing.com/blog/sporting-goods-marketing"
                                                }
                                      ]
                            }
                  ]
      ...
      />
      <Breadcrumbs items={[{ label: "Blog", href: "/blog" }, { label: "Sporting Goods Retail Marketing" }]} />
