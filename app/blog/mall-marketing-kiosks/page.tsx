                  ...
                  "@graph": [
                            {
                                      ...
                                      "mainEntityOfPage": {
                                                "@type": "WebPage",
                                                "@id": "https://www.airfreshmarketing.com/blog/mall-marketing-kiosks"
                                      },
                                      "inLanguage": "en-US",
                            ...
                            },
                            {
                                      ...
                                      "itemListElement": [
                                                ...
                                                },
                                                {
                                                          ...
                                                          "item": "https://www.airfreshmarketing.com/blog/mall-marketing-kiosks"
                                                }
                                      ]
                            }
                  ]
        ...
        <div className="not-prose">
          <div className="bg-gradient-to-r from-pink-600 to-rose-600 text-white p-8 rounded-xl">
            ...
            <Button asChild size="lg" className="bg-white text-rose-600 hover:bg-gray-100">
              <Link href="/get-quote?source=blog-mall-marketing-kiosks&intent=article-cta">Get a Quote <ArrowRight className="w-5 h-5 ml-2" /></Link>
            </Button>
          </div>
        </div>
