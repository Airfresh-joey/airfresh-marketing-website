...
export const metadata: Metadata = {
  title: 'B2B Event Marketing: Turning Handshakes into Deals',
        ...
        <div className="not-prose">
          <div className="bg-gradient-to-r from-blue-700 to-indigo-800 text-white p-8 rounded-xl">
            ...
            <Button asChild size="lg" className="bg-white text-blue-700 hover:bg-gray-100">
              <Link href="/get-quote?source=blog-b2b-event-marketing&intent=article-cta">Get Started <ArrowRight className="w-5 h-5 ml-2" /></Link>
            </Button>
          </div>
        </div>
