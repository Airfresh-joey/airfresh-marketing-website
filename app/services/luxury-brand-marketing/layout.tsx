...
export const metadata: Metadata = {
  ...
  description: 'Luxury brand experiential marketing with exclusive VIP activations and premium brand representation. White-glove service for high-end brands.',
  alternates: {
