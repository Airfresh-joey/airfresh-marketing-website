...
export const metadata: Metadata = {
  ...
  description: 'Retail activations and in-store marketing that drive sales at point of purchase. Product demonstrations, sampling, and brand ambassador programs.',
  alternates: {
