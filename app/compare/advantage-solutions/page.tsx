      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            { href: '/get-quote?source=compare-advantage-solutions&intent=related-request-quote', label: 'Request a Quote' },
          ].map((link) => (
      ...
      <section className="relative py-20 sm:py-28 bg-gradient-to-br from-[#002B5B] via-[#003d7a] to-[#002B5B] overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/get-quote?source=compare-advantage-solutions&intent=final-cta">
