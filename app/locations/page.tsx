  ...
  return (
    <div className="pt-16 min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Formula 1 Las Vegas experiential marketing activation"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Browse All Cities</h2>
            <p className="text-lg text-gray-600">
              We provide experiential marketing services in {allCitiesData.length}+ cities nationwide
            </p>
          </div>
