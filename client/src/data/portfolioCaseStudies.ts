...
export const portfolioCaseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    description: "+44 Formula One collaborated with The Wynn Las Vegas to execute a brand activation during the Formula 1 event in Las Vegas from November 20-30, 2024. Our team provided exceptional brand ambassadors and experiential event staffing, creating an engaging atmosphere that enhanced brand visibility and customer interaction throughout the event.",
  ...
  // ============ TECHNOLOGY & MEDIA ============
  {
    ...
    description: "Air Fresh Marketing partnered with Microsoft to execute event staffing and guest experience management at the National Retail Federation Show in New York City. Our team provided high-touch support and on-site leadership, ensuring seamless coordination and professional service throughout the multi-day engagement.",
    industry: "Technology",
  ...
  },
  {
    ...
    description: "Lyft partnered with Air Fresh Marketing to execute multi-market experiential activations across major cities such as Chicago, Dallas, Denver, Los Angeles, Miami, and New York City from June to September 2023. Our services included brand activation and event staffing, which successfully enhanced brand visibility and engagement in each market.",
