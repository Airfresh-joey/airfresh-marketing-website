...
export const cities: CityData[] = [
  ...
  // Additional cities from live site
  { city: "St. Petersburg", state: "Florida", slug: "st-petersburg", population: "265K", marketSize: "Medium", industries: ["Tourism", "Healthcare", "Tech"] },
  { city: "Fort Worth", state: "Texas", slug: "fort-worth", population: "935K", marketSize: "Large", industries: ["Aerospace", "Manufacturing", "Healthcare"] },
  { city: "Fort Lauderdale", state: "Florida", slug: "fort-lauderdale", population: "185K", marketSize: "Medium", industries: ["Tourism", "Marine", "Finance"] },
  { city: "Anaheim", state: "California", slug: "anaheim", population: "350K", marketSize: "Large", industries: ["Tourism", "Tech", "Manufacturing"] },
  { city: "Santa Monica", state: "California", slug: "santa-monica", population: "93K", marketSize: "Large", industries: ["Tech", "Entertainment", "Tourism"] },
  { city: "Pasadena", state: "California", slug: "pasadena", population: "140K", marketSize: "Large", industries: ["Tech", "Education", "Healthcare"] },
  { city: "Burbank", state: "California", slug: "burbank", population: "108K", marketSize: "Large", industries: ["Entertainment", "Media", "Tech"] },
  { city: "Glendale", state: "California", slug: "glendale-ca", population: "195K", marketSize: "Large", industries: ["Entertainment", "Healthcare", "Retail"] },
  { city: "Hollywood", state: "California", slug: "hollywood", population: "85K", marketSize: "Large", industries: ["Entertainment", "Media", "Tourism"] },
  { city: "Beverly Hills", state: "California", slug: "beverly-hills", population: "33K", marketSize: "Large", industries: ["Entertainment", "Luxury Retail", "Real Estate"] },
  { city: "West Hollywood", state: "California", slug: "west-hollywood", population: "35K", marketSize: "Large", industries: ["Entertainment", "Fashion", "Nightlife"] },
  { city: "Manhattan Beach", state: "California", slug: "manhattan-beach", population: "35K", marketSize: "Large", industries: ["Tech", "Aerospace", "Retail"] },
  { city: "Huntington Beach", state: "California", slug: "huntington-beach", population: "200K", marketSize: "Large", industries: ["Tourism", "Oil & Gas", "Retail"] },
  { city: "Newport Beach", state: "California", slug: "newport-beach", population: "85K", marketSize: "Large", industries: ["Finance", "Tourism", "Real Estate"] },
  { city: "Laguna Beach", state: "California", slug: "laguna-beach", population: "23K", marketSize: "Medium", industries: ["Tourism", "Art", "Real Estate"] },
  { city: "San Bernardino", state: "California", slug: "san-bernardino", population: "220K", marketSize: "Medium", industries: ["Logistics", "Healthcare", "Education"] },
  { city: "Ontario", state: "California", slug: "ontario-ca", population: "175K", marketSize: "Medium", industries: ["Logistics", "Manufacturing", "Retail"] },
  { city: "Rancho Cucamonga", state: "California", slug: "rancho-cucamonga", population: "180K", marketSize: "Medium", industries: ["Logistics", "Healthcare", "Retail"] },
  { city: "Fontana", state: "California", slug: "fontana", population: "215K", marketSize: "Medium", industries: ["Logistics", "Manufacturing", "Motorsports"] },
  { city: "Moreno Valley", state: "California", slug: "moreno-valley", population: "210K", marketSize: "Medium", industries: ["Logistics", "Healthcare", "Manufacturing"] },
  { city: "Oxnard", state: "California", slug: "oxnard", population: "205K", marketSize: "Medium", industries: ["Agriculture", "Manufacturing", "Military"] },
  { city: "Thousand Oaks", state: "California", slug: "thousand-oaks", population: "125K", marketSize: "Medium", industries: ["Biotech", "Healthcare", "Tech"] },
  { city: "Simi Valley", state: "California", slug: "simi-valley", population: "125K", marketSize: "Medium", industries: ["Aerospace", "Manufacturing", "Tech"] },
  { city: "Santa Clarita", state: "California", slug: "santa-clarita", population: "230K", marketSize: "Medium", industries: ["Entertainment", "Aerospace", "Tech"] },
  { city: "Palmdale", state: "California", slug: "palmdale", population: "170K", marketSize: "Medium", industries: ["Aerospace", "Manufacturing", "Retail"] },
  { city: "Lancaster", state: "California", slug: "lancaster-ca", population: "175K", marketSize: "Medium", industries: ["Aerospace", "Renewable Energy", "Healthcare"] },
  { city: "Elk Grove", state: "California", slug: "elk-grove", population: "175K", marketSize: "Medium", industries: ["Healthcare", "Retail", "Government"] },
  { city: "Roseville", state: "California", slug: "roseville", population: "150K", marketSize: "Medium", industries: ["Tech", "Healthcare", "Retail"] },
  { city: "Sunnyvale", state: "California", slug: "sunnyvale", population: "155K", marketSize: "Large", industries: ["Tech", "Semiconductors", "Software"] },
  { city: "Santa Clara", state: "California", slug: "santa-clara", population: "130K", marketSize: "Large", industries: ["Tech", "Semiconductors", "Sports"] },
  { city: "Mountain View", state: "California", slug: "mountain-view", population: "82K", marketSize: "Large", industries: ["Tech", "Software", "AI"] },
  { city: "Palo Alto", state: "California", slug: "palo-alto", population: "66K", marketSize: "Large", industries: ["Tech", "VC", "Education"] },
  { city: "Fremont", state: "California", slug: "fremont", population: "230K", marketSize: "Large", industries: ["Tech", "Manufacturing", "Healthcare"] },
  { city: "Hayward", state: "California", slug: "hayward", population: "160K", marketSize: "Large", industries: ["Manufacturing", "Healthcare", "Biotech"] },
  { city: "Berkeley", state: "California", slug: "berkeley", population: "125K", marketSize: "Large", industries: ["Education", "Biotech", "Tech"] },
  { city: "Daly City", state: "California", slug: "daly-city", population: "105K", marketSize: "Large", industries: ["Healthcare", "Retail", "Tech"] },
  { city: "San Mateo", state: "California", slug: "san-mateo", population: "105K", marketSize: "Large", industries: ["Tech", "Biotech", "Finance"] },
  { city: "Redwood City", state: "California", slug: "redwood-city", population: "85K", marketSize: "Large", industries: ["Tech", "Biotech", "Legal"] },
  { city: "South San Francisco", state: "California", slug: "south-san-francisco", population: "70K", marketSize: "Large", industries: ["Biotech", "Pharma", "Logistics"] },
  { city: "Walnut Creek", state: "California", slug: "walnut-creek", population: "70K", marketSize: "Large", industries: ["Finance", "Healthcare", "Retail"] },
  { city: "Concord", state: "California", slug: "concord-ca", population: "130K", marketSize: "Medium", industries: ["Healthcare", "Retail", "Manufacturing"] },
  { city: "Antioch", state: "California", slug: "antioch", population: "115K", marketSize: "Medium", industries: ["Healthcare", "Retail", "Manufacturing"] },
  { city: "Vallejo", state: "California", slug: "vallejo", population: "120K", marketSize: "Medium", industries: ["Healthcare", "Government", "Tourism"] },
  { city: "Fairfield", state: "California", slug: "fairfield", population: "120K", marketSize: "Medium", industries: ["Military", "Healthcare", "Agriculture"] },
  { city: "Napa", state: "California", slug: "napa", population: "80K", marketSize: "Medium", industries: ["Wine", "Tourism", "Healthcare"] },
  { city: "Santa Rosa", state: "California", slug: "santa-rosa", population: "180K", marketSize: "Medium", industries: ["Wine", "Healthcare", "Tech"] },
  { city: "Modesto", state: "California", slug: "modesto", population: "215K", marketSize: "Medium", industries: ["Agriculture", "Healthcare", "Manufacturing"] },
  { city: "Visalia", state: "California", slug: "visalia", population: "145K", marketSize: "Small", industries: ["Agriculture", "Healthcare", "Retail"] }
];
